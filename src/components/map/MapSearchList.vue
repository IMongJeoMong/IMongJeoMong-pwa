...
<style>
    ...
    .search_list_box_info > div{
        width:100%;
        display: flex;
        
    }

    .search_list_box_info_main{
        width:65%;
        padding-right: 5px;
        font-size:12px;
        font-weight:300;
